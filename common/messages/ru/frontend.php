...
return [
    ...
    'depth' => 'Толщина',
    'density' => 'Плотность',
    'outer_metal_depth' => 'Внешняя сторона металла',
    'internal_metal_depth' => 'Внутренняя сторона металла',
    'coating' => 'покрытие',
    ...
    'calculation' => 'ПОЛУЧИТЕ индивидуальный расчет СТОИМОСТИ',
    'projects' => 'Проекты из сэндвич-панелей',
    'equipments' => 'Холодильное оборудование',
    'contacts' => 'КОНТАКТЫ',
    'address' => 'г.Ровно ул. Старицкого 45',
    'questions' => 'ОСТАЛИСЬ ВОПРОСЫ?',
    'request_call_managers' => "Закажите обратный звонок и наши менеджеры свяжутся с Вами в ближайшее время",
    'thanks' => 'Спасибо за обращение',
    'managers' => "Наши менеджеры свяжутся с Вами в ближайшее время",
    'Request_call' => 'Заказать звонок',
    'placeholder_name' => "Введите Ваше имя",
    'placeholder_email' => 'Введите Ваш email',
    'placeholder_phone' => 'Введите Ваш телефон',
